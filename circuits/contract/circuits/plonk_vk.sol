// Verification Key Hash: def2a9b87cf955a23f969386b717e90d41cc7f03259b83e4390e96410ece8ca0
...
library UltraVerificationKey {
    function verificationKeyHash() internal pure returns(bytes32) {
        return 0xdef2a9b87cf955a23f969386b717e90d41cc7f03259b83e4390e96410ece8ca0;
    }
    ...
    function loadVerificationKey(uint256 _vk, uint256 _omegaInverseLoc) internal pure {
        assembly {
            ...
            mstore(add(_vk, 0x300), 0x140c4e608e2991031bc90977973643eecd73ce52b1db8e7a498eda99d8f27364) // vk.SIGMA1.x
            mstore(add(_vk, 0x320), 0x1c25b2e929f2ebf4abc49d20e9bd93922e4c6369fe0f150d7f9b287d943d5c14) // vk.SIGMA1.y
            mstore(add(_vk, 0x340), 0x22a18aecb0eaa29b076cb070140054a079a769ae0ae0fe5a27a695910af8c255) // vk.SIGMA2.x
            mstore(add(_vk, 0x360), 0x1e9df46fd540e9fe9b1e82c108fef5da1de7c7b43d9d97d75f9a1da31f7b7db7) // vk.SIGMA2.y
            mstore(add(_vk, 0x380), 0x058583efef671d29c10ac891afe1abde8a93652864dc32d81c987d5d0d8ca150) // vk.SIGMA3.x
            mstore(add(_vk, 0x3a0), 0x2b27ae49ab5e34a2cf43d7acdbae174c2d59c33ac1d16edbaee12e7ace3d48a2) // vk.SIGMA3.y
            ...
            mstore(add(_vk, 0x580), 0x1e65ca04b468d71eea19f24f84d418fa671f4f40372635975d4e78cb8e6f3a9e) // vk.ID2.x
            mstore(add(_vk, 0x5a0), 0x06ecc2b8b43fd4da01687b213ad7df18ded35381cba99176d14dea7ce85079d5) // vk.ID2.y
            ...
            mstore(add(_vk, 0x600), 0x168dd24adc55052f6fdbb56796cd3183ad36468667f272e805507018aa4c66e6) // vk.ID4.x
            mstore(add(_vk, 0x620), 0x2fba7e99b55e666e03982cdd6117b4d87baa0df11f38c592b27525236b079ec8) // vk.ID4.y
